...
const socialLinks = [
  { 
    name: "GitHub", 
    href: "https://github.com/Jalak-Palan",
    icon: (
  ...
  { 
    name: "LinkedIn", 
    href: "https://www.linkedin.com/in/jalak-palan-726597367/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  { 
    name: "YouTube", 
    href: "https://www.youtube.com/@JALAKPALAN-q8i",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="py-8 border-t border-[#262626] bg-[#0a0a0a]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-6">
          ...
          >
            <span className="text-white font-medium">Jalak Palan</span>
